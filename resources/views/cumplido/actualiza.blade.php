                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @foreach ($DESTINATARIOS_CUMPLIDOS as $destinatario )
                                            ...
                                            <div class="form-check">
                                                ...
                                                @if(isset($confirmacumplido[$destinatario[2]]))
                                                    <input disabled class="form-check-input" type="checkbox" name="correos[]" value="{{ $destinatario[2] }}">
                                                    <label class="form-check-label text-success" for="envio1" title="{{ $destinatario[2] }}">
                                                        {{ $destinatario[0] . '(Confirmada en: ' . $confirmacumplido[$destinatario[2]] . ')'}}
                                                @else
